...
<div id="About Me" class="blurb">
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-5">
        <h1 class="pull-right"><img src="images/NielsVrolijk-vierkant_reasonably_small.jpg" alt="Niels Vrolijk" /></i></h1>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        I'm a SharePoint and Microsoft Development consultant working for <a href="http://www.rubicon.nl">Rubicon</a>, a small firm specialized in Microsoft solutions.
      </div>
    </div>
  </div>
</div>
<!--
<div class="featurette" id="Certifications">
  <div class="container">
    <div class="row">
  ...
  <div class="vert">
    ...
    <div class="col-md-8 col-md-offset-2 text-center">
      <div class="row hidden-xs">
       <div class="col-sm-2"><img class=" grayscale" src="images/MCSD_2013_SP.png"></div>
       <div class="col-sm-2"><img class=" grayscale" src="images/MCSD_2013_SP.png"></div>
       <div class="col-sm-2"><img class=" grayscale" src="images/MCSD_2013_SP.png"></div>
       <div class="col-sm-2"><img class=" grayscale" src="images/MCSD_2013_SP.png"></div>
       <div class="col-sm-2"><img class=" grayscale" src="images/MCSD_2013_SP.png"></div>
    ...
    <div class="row">
      <div class="col-md-6 col-md-offset-3 text-center">
        <ul class="list-inline">
          ...
          <li><i class="icon-twitter icon-2x">http://twitter.com/NielsV</i></li>
          <li><i class="icon-google-plus icon-2x"></i></li>
          <li><i class="icon-pinterest icon-2x"></i></li>
        </ul>
        <hr>
        <p>&copy; Niels Vrolijk 2015</p>
      </div>
    </div>
  </div>
</footer>
